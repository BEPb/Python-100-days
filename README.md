...
- Программы и базы-инструкции и программы / Машина фон Неймана / Двоичная и десятичная / Восьмеричная и 
  шестнадцатеричная
...
- 
### День 03 - отраслевая структура
- Сценарии применения структуры ветвления-условие / отступ / блок кода / блок-схема
- простая инструкция if if / if-else структура / if-elif-else структура / вложенная if
- Пример приложения - Проверка личности пользователя / Обмен английскими и метрическими единицами / Решение, что 
  делать, бросая кости / Преобразование процентной системы в систему оценок / Оценка кусочной функции / Ввод длины трех сторон, если он может образовать треугольник, вычислить периметр и площадь

### День 04- Структура цикла
- Сценарии применения цикла структура-условие / отступ / кодовый блок / блок-схема
в то время как основная структура цикла / оператор прерывания / оператор продолжения
для базовой структуры цикла / типа диапазона / структуры ветвления в цикле / вложенном цикле / ранней завершающей 
  программе
- Пример приложения-1 ~ 100 суммирование / оценка простых чисел / игра в угадывание чисел / печать девяти-девяти 
  таблиц / печать шаблонов треугольников / обезьяны, едящие персики / сто денег и сто цыплят
...
### День 07 - Строки и общие структуры данных
- Использование строковых вычислений длины / индексации / нарезки / общих методов
- Базовое использование списка с определением списка / использование следующей таблицы для доступа к элементу / 
  индексу за пределами границ / добавление элемента / удаление элемента / изменение элемента / срез / обход цикла
- Общие операции со списком - объединение / копирование (копирование элементов и копирование массива) / длина / 
  сортировка / обратное / поиск
- Генерация списка использования диапазона для создания списка чисел / генерации выражений / генераторов
...
- Базовое использование коллекции - разница между коллекцией и списком / создать коллекцию / добавить элемент / 
...
- Комплексный чехол - Выбор номера двухцветного мяча / Крестики-нолики
...
### День 09 - Продвинутая объектно-ориентированная программа
