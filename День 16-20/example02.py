"""
Сортировка-пузырьковая сортировка, выборочная сортировка, сортировка слиянием, быстрая сортировка
Bubbling Sort-O (n ** 2): сравнить попарно, большая раковина
35, 97, 12, 68, 55, 73, 81, 40
35, 12, 68, 55, 73, 81, 40, [97]
12, 35, 55, 68, 73, 40, [81]
12, 35, 55, 68, 40, [73]
...
Selection sort-O (n ** 2): каждый раз выбирать наименьший из оставшихся элементов
-----------------------------------------
Сортировка слиянием-O (n * log_2 n) - Расширенный алгоритм сортировки
35, 97, 12, 68, 55, 73, 81, 40
[35, 97, 12, 68], [55, 73, 81, 40]
[35, 97], [12, 68], [55, 73], [81, 40]
[35], [97], [12], [68], [55], [73], [81], [40]
...
-----------------------------------------
Быстрая сортировка: разделите элементы в списке на две части с точкой поворота в качестве границы, левая сторона меньше, чем точка поворота, а правая сторона больше, чем точка поворота.
35, 97, 12, 68, 55, 73, 81, 40
