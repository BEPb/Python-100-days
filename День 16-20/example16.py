...
Первый используется для вычисления хэш-кода объекта, а второй используется для определения того, являются ли два объекта одинаковыми.
Объекты с разными хэш-кодами должны быть разными объектами, но один и тот же хэш-код не обязательно может быть одним и тем же объектом (конфликт хеш-кода)
