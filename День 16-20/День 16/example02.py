...
-----------------------------------------
Быстрая сортировка: разделите элементы в списке на две части с точкой поворота в качестве границы, левая сторона
меньше, чем точка поворота, а правая сторона больше, чем точка поворота.
35, 97, 12, 68, 55, 73, 81, 40
